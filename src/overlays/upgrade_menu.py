...
class UpgradeMenu(Sprite):
    def __init__(self) -> None:
        ...
        self._menu_setup()
        overlay_sprites.remove(element for element in self.menu_ui)
    ...
    def _menu_setup(self) -> None:
        ...
        self.item_title_textbox = Textbox(overlay_sprites, self, offset = (40, 20))
        ...
        for col in range(self.num_of_cols):
            slot = UpgradeIconBg(overlay_sprites)
    ...
    def show_menu(self) -> None:
        ...
        overlay_sprites.add(element for element in self.display_group)
