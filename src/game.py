...
from src.utils.cameras import cameragroup_layers, overlay_layers
from src.event_managing import EventHandler
...
class Level:
    ...
    def setup(self) -> None:
        ...
        self.player = Player_Character(self, self.draw_groups, 'galleon')
